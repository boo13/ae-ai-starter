...
Setup can generate a dockable ScriptUI panel (`Scripts/panel/project_panel.jsx`) with buttons for refreshing analysis and loading data files. The setup script offers to symlink it into AE's ScriptUI Panels folder.
