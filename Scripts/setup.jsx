...
(function () {
    ...
    var defaultName = aepName.replace(/\.(aep|aepx)$/i, "");
    ...
    if (createPanel) {
        ...
        var panelFile = new File(panelDir.fsName + "/project_panel.jsx");
        var panelContent = buildPanelScript(projectName);
    ...
    if (panelCreated) {
        summary += "- Panel created: Scripts/panel/project_panel.jsx\n";
    }
     ...
     */
    function buildPanelScript(name) {
        var lines = [];

        lines.push("/**");
        lines.push(" * project_panel.jsx");
        lines.push(" *");
